...
#define RVOSEEDRANDOMNUMBERGENERATOR
...
namespace RVO
{
    class Blocks
    {
        ...
        Blocks()
        {
            ...
            #if RVOSEEDRANDOMNUMBERGENERATOR
        ...
        void setupScenario()
        {
            ...
            for (int i = 0; i < 5; ++i)
            {
                for (int j = 0; j < 5; ++j)
                {
                    Simulator.Instance.addAgent(new Vector3(55.0f + i * 10.0f, 55.0f + j * 10.0f, 55.0f + j * 10.0f));
                    goals.Add(new Vector3(-75.0f, -75.0f));

                    Simulator.Instance.addAgent(new Vector3(-55.0f - i * 10.0f, 55.0f + j * 10.0f));
                    goals.Add(new Vector3(75.0f, -75.0f));
            ...
            obstacle1.Add(new Vector3(-10.0f, 40.0f));
            obstacle1.Add(new Vector3(-40.0f, 40.0f));
            obstacle1.Add(new Vector3(-40.0f, 10.0f));
            obstacle1.Add(new Vector3(-10.0f, 10.0f));
            Simulator.Instance.addObstacle(obstacle1);

            IList<Vector3> obstacle2 = new List<Vector3>();
            obstacle2.Add(new Vector3(10.0f, 40.0f));
            obstacle2.Add(new Vector3(10.0f, 10.0f));
            obstacle2.Add(new Vector3(40.0f, 10.0f));
            obstacle2.Add(new Vector3(40.0f, 40.0f));
            Simulator.Instance.addObstacle(obstacle2);

            IList<Vector3> obstacle3 = new List<Vector3>();
            obstacle3.Add(new Vector3(10.0f, -40.0f));
            obstacle3.Add(new Vector3(40.0f, -40.0f));
            obstacle3.Add(new Vector3(40.0f, -10.0f));
            obstacle3.Add(new Vector3(10.0f, -10.0f));
            Simulator.Instance.addObstacle(obstacle3);

            IList<Vector3> obstacle4 = new List<Vector3>();
            obstacle4.Add(new Vector3(-10.0f, -40.0f));
            obstacle4.Add(new Vector3(-10.0f, -10.0f));
            obstacle4.Add(new Vector3(-40.0f, -10.0f));
            obstacle4.Add(new Vector3(-40.0f, -40.0f));
        ...
        void setPreferredVelocities()
        {
            ...
            for (int i = 0; i < Simulator.Instance.getNumAgents(); ++i)
            {
                ...
                Simulator.Instance.setAgentPrefVelocity(i, Simulator.Instance.getAgentPrefVelocity(i) +
                    dist * new Vector3((float)Math.Cos(angle), (float)Math.Sin(angle)));
            }
        }
